		...
		<div className="flex flex-col bg-[#222] border-t border-[#333]">
			<footer className="py-20 px-[13%] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-[repeat(auto-fit,_minmax(200px,_auto))] gap-14">
				<div className="footer-content">
					...
					<div className="flex text-[#d6d6d6] text-base items-center">
						<IconLink href="#" iconClass="bx bxs-envelope" className="mr-2" />
					...
					<div className="flex text-[#d6d6d6] text-base items-center">
						...
						<span>Washington, D.C. 20036 1717 N Stree, NW, Suite#1</span>
					</div>
				</div>
				...
				<div className="footer-content">
					...
					<div className="relative flex mt-5">
						<input
							...
							className="peer h-10 border-b-2 border-gray-300 text-[#d6d6d6] bg-transparent placeholder-transparent focus:outline-none focus:border-green-700"
						/>

						<label
							htmlFor="email"
							className="absolute left-0 -top-3.5 text-[#d6d6d6] text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-muted-foreground peer-placeholder-shown:top-1 peer-focus:-top-4 peer-focus:text-[#d6d6d6] peer-focus:text-sm peer-focus:font-normal"
						>
							Enter your email
						</label>
						...
						<button
							type="submit"
							className="group w-10 h-10 border-b-2 border-gray-300 peer-focus:border-green-700  hover:text-green-700"
						>
					...
					<div className="icons mt-5">
						<IconLink href="#" iconClass="bx bxl-linkedin-square" />
						<IconLink href="#" iconClass="bx bxl-twitter" />
						<IconLink href="#" iconClass="bx bxl-facebook-circle" />
					</div>
				</div>
			</footer>
