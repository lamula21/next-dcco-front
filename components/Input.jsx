		...
		<div className={width}>
			<div className="relative h-10 w-full">
				<input
					...
					id={inputId}
					className={cn(
						`peer h-full w-full rounded-[7px] px-3 py-2.5 text-sm font-normal outline outline-0 transition-all placeholder-shown:border focus:border-2 focus:border-t-transparent focus:outline-0 disabled:border-0`,
						`border border-${noFocusColor} border-t-transparent bg-${bgColor} text-${inputColor} placeholder-shown:border-${noFocusColor} placeholder-shown:border-t-${noFocusColor} focus:border-${focusColor} disabled:bg-${bgDisabledColor}`
					)}
					placeholder=" "
				/>
				<label
					...
					className={cn(
						...
						`text-${noFocusColor} before:border-${noFocusColor} after:border-${noFocusColor} peer-placeholder-shown:text-${noFocusColor} peer-focus:text-${focusColor} peer-focus:before:border-${focusColor} peer-focus:after:border-${focusColor} peer-disabled:peer-placeholder-shown:text-${textDisabledColor}`
					)}
				>
					{placeholder}
				</label>
